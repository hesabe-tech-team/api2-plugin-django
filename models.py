...
class Credential(TimeStampedModel):
    ...
    accesscode = models.CharField(max_length=255, verbose_name="Access Code",
                                  default="0")
    ...
    knet = models.BooleanField(max_length=50, choices=status_list,
                               verbose_name="KNET Staus", default="Enable")
    mpgs = models.BooleanField(max_length=50, choices=status_list,
                               verbose_name="MPGS Staus", default="Disable")
